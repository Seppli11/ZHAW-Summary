...
Pro Verdoppelung in Schalldruck, nimmt es ~6dB zu: $L=20\cdot log_{10}(\frac p {p_0})$  ($p$=Schalldruck; $p_0$=Bezugsschalldruck)
...
* Linearer Block-Code: Jedes mit Jedem geXored Codewort gibt ein Codewort
