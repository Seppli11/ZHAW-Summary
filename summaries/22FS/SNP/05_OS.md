...
Eine Barrier blockiert mehrere Tasks. Eine Barrier lässt bloss alle Tasks durch, wenn genügend Tasks da sind. Im Vergleich zu dem Sempaphors: 

* Semaphoren: der Busfahrer lässt solange Passagiere in den Bus, bis er voll ist
* Barrier: der Busfahrer wartet bis die gesamte Klasse da ist und lässt sie erst dann
